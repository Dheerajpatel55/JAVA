...
public class Asteroid {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Output 1: " + java.util.Arrays.toString(asteroidCollision(asteroids1)));
        System.out.println("Output 2: " + java.util.Arrays.toString(asteroidCollision(asteroids2)));
        System.out.println("Output 3: " + java.util.Arrays.toString(asteroidCollision(asteroids3)));
    }
}
